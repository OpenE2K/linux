...
/*  Быстрые семафоры со снятием задачи с процессора, без закрытия внешних прерываний */

//#define mutex_init 		init_MUTEX
#define mutex_enter	 	mutex_lock
#define mutex_exit	 	mutex_unlock

/* Медленные семафоры без снятия задачи с процессора, с закрытием маски внешних прерываний,
аналог mutex в Solaris */
