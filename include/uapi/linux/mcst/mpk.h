...
#define	MCST_SUPPORT_BUFF 			0x01	/* 0 О©╫О©╫О©╫ - О©╫О©╫О©╫О©╫О©╫О©╫ '1' - О©╫ О©╫О©╫О©╫О©╫О©╫О©╫О©╫О©╫О©╫О©╫О©╫О©╫, '0' - О©╫О©╫О©╫ О©╫О©╫О©╫О©╫О©╫О©╫О©╫О©╫О©╫О©╫О©╫. */
#define	MCST_CH_B_Tx_BUFFER_FULL	0x40	/* 6 О©╫О©╫О©╫ - О©╫О©╫О©╫О©╫О©╫ О©╫О©╫ О©╫О©╫О©╫О©╫О©╫О©╫О©╫О©╫ О©╫ О©╫О©╫О©╫О©╫О©╫О©╫ B О©╫О©╫О©╫О©╫О©╫ - '1', О©╫О©╫ О©╫О©╫О©╫О©╫О©╫ - '0' */
#define	MCST_CH_A_Tx_BUFFER_FULL	0x80	/* 7 О©╫О©╫О©╫ - О©╫О©╫О©╫О©╫О©╫ О©╫О©╫ О©╫О©╫О©╫О©╫О©╫О©╫О©╫О©╫ О©╫ О©╫О©╫О©╫О©╫О©╫О©╫ A О©╫О©╫О©╫О©╫О©╫ - '1', О©╫О©╫ О©╫О©╫О©╫О©╫О©╫ - '0' */
