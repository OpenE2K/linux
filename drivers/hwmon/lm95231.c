...
/*
 * Support for LM95231 temperature sensor, based on LM95241 driver.
 */
...
#ifdef CONFIG_MCST
static const struct of_device_id lm95231_of_match[] = {
	{ .compatible = "ti,lm95231" },
	{},
};
MODULE_DEVICE_TABLE(of, lm95231_of_match);
#endif
...
static struct i2c_driver lm95231_driver = {
	...
	.driver = {
		.name   = "lm95231",
#ifdef CONFIG_MCST
		.of_match_table = of_match_ptr(lm95231_of_match),
#endif
	},
	.probe		= lm95231_probe,
