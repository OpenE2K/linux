#ifndef	__LINUX_MCKP_H__
#define	__LINUX_MCKP_H__
 ...
 */
#define MCKP_NAME	"MCST,mckp"
#define MCKP_DIR	"mckp"
#define	mod_name	"mckp"
#define board_name	"MCST,mckp"
...
//	buf_t *		multi_buf_lock;		/* system buffer pointer of */
    ...
    mp_drv_args_t	 work_timetable;    /* timetable of work args */
    int                  timetable_seted;   /* the timetable of work is seted */
    int                  timetable_set_error;   /* the timetable is set with */
						/* error */
...
typedef struct mckp_state {
	...
	kcondvar_t		drv_comm_cv;	/* driver communication area */
						/* busy free condition */
						/* variable */
//  pid_t pid_state_mckp_intr_handler;
//  pid_t pid_mckp_watchdog_handler;
//  wait_queue_head_t	state_mckp_intr_handler;
//  wait_queue_head_t	mckp_watchdog_handler;
	struct work_struct	interrupt_tqueue;
	struct work_struct	watchdog_tqueue;
	mc_rd_reg_t			read_value;

//	int wakeup_flag;
//	int waking_up_mckp_intr_handler;
//	int state_mckp_intr_handler_shutdown;
//	int waking_up_mckp_watchdog_handler;
//	int mckp_watchdog_handler_shutdown;
	...
	init_trans_spec_t	 init_trans_modes_spec; /* initial transfer mode */
	...
	mckp_chnl_state_t all_channels_state[MAX_MC_BOARD_CHANNEL_NUM]; /* all board channel states */
	mp_intr_spec_t       mp_timer_intrs;   /* MP timer interrupts processing */
} mckp_state_t;

extern	void	*mckp_state;	/* driver state list pointer */
...
int	mckp_halt_trans_mode(mckp_state_t		*state);
...
#define submit_mp_task(arg1, arg2, arg3, arg4, arg5, arg6, arg7) \
({int res = submit_mp_task1(arg1, arg2, arg3, arg4, arg5, arg6, arg7); /*printk("%d %s\n",__LINE__,__FUNCTION__);*/res;})
