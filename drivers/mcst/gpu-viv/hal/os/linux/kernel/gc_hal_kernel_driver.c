...
#define GC2500_BAR	3
	...
	pci_set_master(pdev);
	irqLine = pdev->irq;
	registerMemBase = pci_resource_start(pdev, GC2500_BAR);
	registerMemSize = pci_resource_len(pdev, GC2500_BAR);
	contiguousBase = pci_resource_start(pdev, VRAM_BAR);
	contiguousSize = pci_resource_len(pdev, VRAM_BAR);
#endif	/*CONFIG_MCST*/
