...
extern int DC390_bios_param(struct scsi_device *sdev, struct block_device *bdev,
		       sector_t capacity, int geom[]);
extern int DC390_ioctl(Scsi_Device *dev,int cmd_ioctl,void *arg);
//extern int DC390_private_ioctl(struct Scsi_Host *,struct ifreq *rq,int cmd_ioctl);
