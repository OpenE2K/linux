...
#define ERRDMA_GP0_SEND			-32 /* ошибка при посылке GP0 */
#define ERRDMA_GP1_SEND			-33 /* ошибка при посылке GP1 */
#define ERRDMA_GP2_SEND			-34 /* ошибка при посылке GP2 */
#define ERRDMA_GP3_SEND			-35 /* ошибка при посылке GP3 */
#define ERRDMA_ID_SEND			-36 /* ошибка при посылке ID request */
#define ERRDMA_SET_MASK			-37 /* ошибка установки маски прерываний */
#define ERRDMA_THREAD_RESET_START	-38 /* ошибка создания потока reset */
