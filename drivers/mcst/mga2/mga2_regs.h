...
#define	 MGA2_DC0_CTRL		0x00000	/* общее управление работой дисплейного контроллера */
...
#define	 MGA2_DC0_VGAWINOFFS		0x00004	/* сдвиг отображаемой в VGA-MEM области памяти. */
#define	 MGA2_DC0_VGABASE		0x00008	/* адрес в видеопамяти дисплейного контроллер */
#define	 MGA2_DC0_VGAREGS		0x0000С	/* доступ в VGA-IO пространство регистров. */
#define	 MGA2_DC0_TMPADDR		0x00010	/* Адрес off-screen области видеопамяти для различных временных буферов видеоконтроллера */

#define	 MGA2_DC0_PIXFMT		0x00020	/* формат изображаемых пикселей */
...
#define	 MGA2_DC0_WCRSADDR	0x00038	/* текущий адрес и управление курсором (R/O) */
#define	 MGA2_DC0_WCRSCOORD	0x0003C	/* текущие координаты курсора (R/O) */
#define	 MGA2_DC0_WPALID	0x00040	/* текущая страница палитры и ID (R/O) */
#define	 MGA2_DC0_NSTART	0x00050	/* следующий стартовый адрес экрана (R/W) */
#define	 MGA2_DC0_NOFFS		0x00054	/* следущий шаг строк экрана (R/W) */

#define	 MGA2_DC0_NCRSADDR	0x00058	/* следущий адрес и управление курсором (R/W) */
#define	 MGA2_DC_B_CRS_ENA	(1 << 0)

#define	 MGA2_DC0_NCRSCOORD	0x0005C	/* следущие координаты курсора (R/W) */
#define	 MGA2_DC0_NPALID	0x00060	/* следущая страница палитры и ID (R/W) */
#define	 MGA2_DC0_DISPCTRL	0x00064	/* управление переключением дисплейных буферов курсора и палитры */
#define MGA2_DC_B_STROB        (1 << 31)

#define	 MGA2_DC0_HVCTRL	0x00070	/* управление развёртками */
...
#define	 MGA2_DC0_HSYNC		0x00074	/* ширина сигнала горизонтальной синхронизации */
#define	 MGA2_DC0_HDELAY	0x00078	/* задержка между горизонтальным синхроиспульс */
#define	 MGA2_DC0_HVIS		0x0007C	/* ширина видимой области */
#define	 MGA2_DC0_HTOT		0x00080	/* полная ширина строки */
#define	 MGA2_DC0_VSYNC		0x00084	/* высота сигнала вертикальной синхронизации */
#define	 MGA2_DC0_VDELAY		0x00088	/* задержка между вертикальным синхроиспульсом и видимой областью */
#define	 MGA2_DC0_VVIS		0x0008C	/* высота видимой области */
#define	 MGA2_DC0_VTOT		0x00090	/* полный размер кадра */
#define	 MGA2_DC0_HCOUNT	0x00094	/* счётчик горизонтальной развёртки */
#define	 MGA2_DC0_VCOUNT	0x00098	/* счётчик вертикальной развёртки */
#define	 MGA2_DC0_PALADDR	0x000A0	/* регистр адреса палитры */

#define	 MGA2_DC_B_AUTOINC       (1 << 31)

#define	 MGA2_DC0_PALDATA	0x000A4	/* регистр данных палитры */
#define	 MGA2_DC0_GAMCTRL	0x000A8	/* регистр управления гамма-коррекцией */
#define MGA2_DC_GAMCTRL_ENABLE	(1 << 31)

#define	 MGA2_DC0_GAMSET		0x000AC	/* регистр установки таблиц гамма-коррекции */
...
#define	 MGA2_DC0_DITCTRL		0x000B0	/* регистр управления дизерингом */
#define MGA2_DC_DITCTRL_ENABLE         (1 << 31)
#define MGA2_DC_DITCTRL_DISABLE        (0 << 31)

#define	 MGA2_DC0_DITSET0		0x000B4	/* регистр установки таблицы дизеринга */
#define	 MGA2_DC0_DITSET1		0x000B8	/* регистр установки таблицы дизеринга */

#define	 MGA2_DC0_CLKCTRL		0x000C0	/* регистр управления пиксельной частотой */
...
#define	 MGA2_DC0_INTPLLCTRL		0x000D0	/* управление внутренним PLL общий контроль */
#define	 MGA2_DC0_INTPLLCLKF0		0x000E0	/* управление внутренним PLL, CLKF #0 */
#define	 MGA2_DC0_INTPLLCLKR0		0x000E4	/* управление внутренним PLL, CLKR #0 */
#define	 MGA2_DC0_INTPLLCLKOD0		0x000E8	/* управление внутренним PLL, CLKOD #0 */
#define	 MGA2_DC0_INTPLLBWADJ0		0x000EC	/* управление внутренним PLL, BWADJ #0 */
#define	 MGA2_DC0_INTPLLCLKF1		0x000F0	/* управление внутренним PLL, CLKF #1 */
#define	 MGA2_DC0_INTPLLCLKR1		0x000F4	/* управление внутренним PLL, CLKR #1 */
#define	 MGA2_DC0_INTPLLCLKOD1		0x000F8	/* управление внутренним PLL, CLKOD #1 */
#define	 MGA2_DC0_INTPLLBWADJ1		0x000FC	/* управление внутренним PLL, BWADJ #1 */
...
#define	MGA2_DC0_GPIO_MUX		0x00120	/* мультиплексирование GPIO. */
#define MGA2_DC_B_GPIOMUX_CS1		(1 << 1)
#define MGA2_DC_B_GPIOMUX_CS0		(1 << 0)
#define	MGA2_DC0_GPIO_MUXSETRST		0x00124	/* побитовая установка или очистка регистра \
						   MGA2_DC0_GPIO_MUX. */
#define	 MGA2_DC0_GPIO_PUP		0x00128	/* управление пуллапами GPIO. */
#define	 MGA2_DC0_GPIO_PUPSETRST		0x0092C	/* побитовая установка или очистка регистра \
							   MGA2_DC0_GPIO_PUP */
#define	 MGA2_DC0_GPIO_DIR		0x00130	/* управление направлением пина (вход или выход). */
#define	 MGA2_DC0_GPIO_DIRSETRST		0x00934	/* побитовая установка или очистка регистра \
							   MGA2_DC0_GPIO_DIR */
#define	 MGA2_DC0_GPIO_OUT		0x00138	/* установка уровня пина при его работе на выход. */
#define	 MGA2_DC0_GPIO_OUTSETRST		0x0093C	/* побитовая установка или очистка регистра \
							   MGA2_DC0_GPIO_OUT */
#define	 MGA2_DC0_GPIO_IN		0x00140	/* чтение состояния пинов. */
...
#define	 MGA2_VID0_MUX		0x00000	/* мультиплексор видеовыходов */
...
#define	 MGA2_VID0_DDCI2C		0x00030	/* управление I2C-контроллером DDC. */
#define	 MGA2_VID0_GPIO_MUX		0x00040	/* мультиплексирование GPIO. */
#define	 MGA2_VID0_GPIO_MUXSETRST	0x00044	/* побитовая установка или очистка регистра MGA2_VID0_GPIO_MUX. */
#define	 MGA2_VID0_GPIO_PUP		0x00048	/* управление пуллапами GPIO. */
#define	 MGA2_VID0_GPIO_PUPSETRST	0x0004C	/* побитовая установка или очистка регистра MGA2_VID0_GPIO_PUP */
#define	 MGA2_VID0_GPIO_DIR		0x00050	/* управление направлением пина (вход или выход). */
#define	 MGA2_VID0_GPIO_DIRSETRST	0x00054	/* побитовая установка или очистка регистра MGA2_VID0_GPIO_DIR */


#define	 MGA2_VID0_GPIO_OUT		0x00058	/* установка уровня пина при его работе на выход. */
# define	MGA2_VID0_GPIO_RSTPIN	(1 << 2)
# define	MGA2_VID0_GPIO_HTPLG	(1 << 4)
# define	MGA2_VID0_GPIO_MSEN	(1 << 5)

#define	 MGA2_VID0_GPIO_OUTSETRST	0x0005C	/* побитовая установка или очистка регистра MGA2_VID0_GPIO_OUT */
#define	 MGA2_VID0_GPIO_IN		0x00060	/* чтение состояния пинов. */

#define	 MGA2_VID3_GPIO_DIR		0x03050	/* управление направлением пина (вход или выход). */
#define	 MGA2_VID3_GPIO_OUT		0x03058	/* установка уровня пина при его работе на выход. */
#define	 MGA2_VID3_GPIO_IN		0x03060	/* чтение состояния пинов. */
