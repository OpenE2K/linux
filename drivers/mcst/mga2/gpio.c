...
#define	 MGA2_GPIO_MUX		0x00000	/* мультиплексирование GPIO. */
#define	 MGA2_GPIO_MUXSETRST	0x00004	/* побитовая установка или очистка регистра MGA2_GPIO_MUX. */
# define MGA2_GPIO_SET_OFFSET	8
#define	 MGA2_GPIO_PUP		0x00008	/* управление пуллапами GPIO. */
#define	 MGA2_GPIO_PUPSETRST	0x0000C	/* побитовая установка или очистка регистра MGA2_GPIO_PUP */
#define	 MGA2_GPIO_DIR		0x00010	/* управление направлением пина (вход или выход). */
#define	 MGA2_GPIO_DIRSETRST	0x00014	/* побитовая установка или очистка регистра MGA2_GPIO_DIR */
#define	 MGA2_GPIO_OUT		0x00018	/* установка уровня пина при его работе на выход. */
#define	 MGA2_GPIO_OUTSETRST	0x0001C	/* побитовая установка или очистка регистра MGA2_GPIO_OUT */
#define	 MGA2_GPIO_IN		0x00020	/* чтение состояния пинов. */
