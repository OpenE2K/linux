...
/*
 * Linux kernel module for Intersil ISL22317 precision single digitally controlled potentiometer.
 */
...
#ifdef CONFIG_MCST
static const struct of_device_id isl22317_of_match[] = {
	{ .compatible = "isl,isl22317" },
	{},
};
MODULE_DEVICE_TABLE(of, isl22317_of_match);
#endif
...
#ifdef CONFIG_MCST
		.of_match_table = of_match_ptr(isl22317_of_match),
#endif
		.owner	= THIS_MODULE,
	},
