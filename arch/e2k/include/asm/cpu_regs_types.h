...
#define	PSP_lo_base	base	/* [47: 0] - base address */
#define	PSP_lo_half	word	/* [63: 0] - entire lower */
...
typedef union {
	...
	u64 word;
} e2k_psp_hi_t;					/* double-word of register */

#define	PSP_hi_size	size	/* [63:32] - size */
#define	PSP_hi_ind	ind	/* [31: 0] - index for SPILL and FILL */
#define	PSP_hi_half	word	/* [63: 0] - entire high double-word of register */
...
#define	_PSP_rw		rw		/* [60:59] - read/write flags */
						/* should be "RW" */
#define	PSP_base	base		/* [47: 0] - base address */
#define	PSP_size	size		/* [63:32] - size */
#define	PSP_ind		ind		/* [31: 0] - index for SPILL and FILL */
#define	PSP_lo_reg	lo.word		/* [63: 0] - entire lower */
						/* double-word of register */
#define	PSP_hi_reg	hi.word		/* [63: 0] - entire high */
						/* double-word of register */
#define	PSP_lo_struct	lo	/* low register structure */
#define	PSP_hi_struct	hi	/* high register structure */
#endif /* !(__ASSEMBLY__) */
...
#define	E2K_GET_INSTR_SYL(instr_addr, syl_no)	\
		(((instr_syl_t __user *)(instr_addr))[syl_no])
...
typedef union e2k_tir_reg {		/* simple TIRj register desc */
	struct {
		struct {
			u64 ip : E2K_VA_SIZE;
			u64    : 64 - E2K_VA_SIZE;
