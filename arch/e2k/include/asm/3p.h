...
({								\
	...
	(E2K_LOAD_TAGD(addr) == E2K_SAP_LO_ETAG ? 1 : 0) : 0);	\
})

#define	IS_SAP_HI(addr)                                  	\
({                                                              \
	(E2K_LOAD_TAGD(addr) == E2K_SAP_HI_ETAG ? 1 : 0);	\
})
...
({								\
	...
	(E2K_LOAD_TAGD(addr) == E2K_AP_LO_ETAG ? 1 : 0) : 0);	\
})

#define	IS_AP_HI(addr)                                  	\
({                                                              \
	(E2K_LOAD_TAGD(addr) == E2K_AP_HI_ETAG ? 1 : 0);	\
})
