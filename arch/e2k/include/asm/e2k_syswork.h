...
/****************************/
//static inline _syscall3(long, e2k_syswork, long, a, long, b, long, c);

#undef clone2
#define _clone2_return(type, res) \
...
#define _clone2_syscall3(type,name,type1,arg1,type2,arg2,type3,arg3) \
	({ \
		long __res; \
	  	   __res = E2K_SYSCALL(LINUX_SYSCALL_TRAPNUM,__NR_##name, 3, \
				arg1, arg2, arg3); \
		_clone2_return(type,__res); \
	})

#define clone2(flags, stack_base, stack_size) \
		_clone2_syscall3(int, clone2, unsigned long, flags, \
			unsigned long long, stack_base,	\
			unsigned long long, stack_size)
#if 0
static inline _syscall3(int, clone2,   unsigned long, flags,
					unsigned long long, stack_base,
					unsigned long long, stack_size)
#endif
...
void cntp_print_chain_stack(struct task_struct *ts);
