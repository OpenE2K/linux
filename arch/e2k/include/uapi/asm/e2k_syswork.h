...
#define PRINT_PT_REGS		5
#define PRINT_REGS		6
#define PRINT_ALL_MMAP		7
#define FLUSH_CMD_CACHES	8
#define	INVALIDATE_ALL_CACHES	10
#define	WRITE_BACK_ALL_CACHES	11
#define SET_TAGS		17
...
#define	DUMP_PREPARE		43
#define	DUMP_START		44
...
#define _e2k_syswork_return(type, res) \
...
#define _e2k_syswork_syscall3(type, name, type1, arg1, \
				type2, arg2, type3, arg3) \
	({ \
		long __res; \
		   __res = E2K_SYSCALL(LINUX_SYSCALL_TRAPNUM, __NR_##name, 3, \
				arg1, arg2, arg3); \
		_e2k_syswork_return(type, __res); \
	})

#define e2k_syswork(a, b, c) \
		_e2k_syswork_syscall3(int, e2k_syswork, unsigned long, a, \
