...
notrace __interrupt
void kvm_guest_save_gregs_v3(global_regs_t *gregs)
{
	gregs->bgr = NATIVE_READ_BGR_REG();
	init_BGR_reg(); /* enable whole GRF */
...
notrace __interrupt
void kvm_guest_save_gregs_dirty_bgr_v3(global_regs_t *gregs)
{
	gregs->bgr = NATIVE_READ_BGR_REG();
	init_BGR_reg(); /* enable whole GRF */
	DO_SAVE_GUEST_GREGS_EXCEPT_KERNEL_V3(gregs->g);
...
notrace __interrupt
void kvm_guest_restore_gregs_v3(const global_regs_t *gregs)
{
	init_BGR_reg();  /* enable whole GRF */
