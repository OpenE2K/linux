...
notrace __interrupt
void save_gregs_on_mask_v3(struct global_regs *gregs, bool dirty_bgr,
...
__section(".entry.text")
notrace __interrupt
void save_gregs_v3(struct global_regs *gregs)
{
	gregs->bgr = NATIVE_READ_BGR_REG();
	init_BGR_reg(); /* enable whole GRF */
	SAVE_GREGS_EXCEPT_KERNEL(gregs->g, E2K_ISET_V3);
...
__section(".entry.text")
notrace __interrupt
void save_gregs_dirty_bgr_v3(struct global_regs *gregs)
{
	gregs->bgr = NATIVE_READ_BGR_REG();
	init_BGR_reg(); /* enable whole GRF */
...
notrace __interrupt
void restore_gregs_on_mask_v3(struct global_regs *gregs, bool dirty_bgr,
...
__section(".entry.text")
notrace __interrupt
void restore_gregs_v3(const struct global_regs *gregs)
{
	init_BGR_reg();  /* enable whole GRF */
