...
/* ABI changed from lcc-1.24 to lcc-1.25, so we have to produce different
 * codes depending on lcc version */
#if defined(__LCC__) && (__LCC__ >= 125)
#define ECOMP_LCC_VERSION_25
#endif /* __LCC__ */

#ifdef ECOMP_LCC_VERSION_25
#define PROF_SAVE_FILE  __BUILTIN_ecomp_prof_SaveFile
#else /* ECOMP_LCC_VERSION_25 */
#define PROF_SAVE_FILE  prof_SaveFile
#endif /* ECOMP_LCC_VERSION_25 */
