...
extern struct irqaction trace_dummy_action[NR_VECTORS];
...
#else
extern __init void l_init_system_handlers_table(void);
extern __init void setup_APIC_vector_handler(int vector,
		void (*handler)(struct pt_regs *), bool system, char *name);
#endif
