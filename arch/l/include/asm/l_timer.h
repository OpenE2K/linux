...
extern int mcst_rt_lt_start(void);
extern int mcst_rt_lt_stop(void);
extern unsigned long lt_get_dintr_time(void);
#endif

/* New (e3s) timer registers */
...
/* E3S System timer Registers (structure see asm/l_timer_regs.h) */
